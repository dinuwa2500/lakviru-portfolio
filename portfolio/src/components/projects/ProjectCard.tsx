...
import { Star, GitFork, ExternalLink, ArrowUpRight, Sparkles } from 'lucide-react';
...
export function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <div className="group relative flex flex-col rounded-xl border border-zinc-200/80 dark:border-zinc-800/80 bg-white/60 dark:bg-zinc-900/60 backdrop-blur-md overflow-hidden hover:border-zinc-300 dark:hover:border-zinc-700 transition-all duration-300 hover:shadow-xl hover:shadow-indigo-500/5 hover:-translate-y-1">
      {/* Thumbnail */}
      <div className="relative h-48 w-full overflow-hidden bg-zinc-950/80 border-b border-zinc-200/60 dark:border-zinc-800/60">
        {project.thumbnail ? (
          <img
