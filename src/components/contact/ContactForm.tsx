    ...
    <section id='contact' className='py-16 sm:py-24 relative'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-12 gap-8 items-start max-w-5xl mx-auto'>
          ...
          <FadeIn direction="right" className='lg:col-span-5 rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 bg-white/70 dark:bg-zinc-900/70 backdrop-blur-md p-6 sm:p-8 space-y-6 shadow-md'>
            ...
            <div className='space-y-4 text-xs sm:text-sm'>
              <div className='flex items-center gap-3 p-3 rounded-xl bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200/60 dark:border-zinc-700/60'>
          ...
          <FadeIn direction="left" className='lg:col-span-7 rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md p-6 sm:p-8 space-y-6 shadow-md'>
